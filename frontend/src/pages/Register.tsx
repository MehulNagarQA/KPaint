  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20 pb-10 px-6 relative">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="glass p-8 rounded-2xl border-[#3e4042] space-y-5">
          <div>
        ...
        <p className="text-center mt-6 text-gray-400">
          Already a member?{' '}
          <Link to="/login" className="text-[#1877F2] hover:text-white transition-colors font-medium">
            Sign In
          </Link>
        </p>
      </div>
